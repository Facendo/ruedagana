...
Route::post('/sorteos/store', [SorteoController::class, 'store'])->name('sorteo.store');
...
Route::delete('/admin/sorteos/{sorteo}', [SorteoController::class, 'destroy'])->name('sorteo.destroy');